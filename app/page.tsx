...
function HomePage() {
  ...
  const testimonials = [
    {
      ...
      name: "Sarah Chen",
      image: "https://eurusworkflows.blob.core.windows.net/eurusworkflows/placeholder-user.jpg",
      position: "bottom-8 right-8"
    },
    {
      quote: "The creative possibilities are endless with Eurus. It's like having a whole team.",
      name: "Marcus Rodriguez",
      image: "https://eurusworkflows.blob.core.windows.net/eurusworkflows/person.jpg",
  ...
  const homeVideos = ["https://eurusworkflows.blob.core.windows.net/eurusworkflows/videos/home1.mp4", "https://eurusworkflows.blob.core.windows.net/eurusworkflows/videos/home2.mp4", "https://eurusworkflows.blob.core.windows.net/eurusworkflows/videos/home3.mp4", "https://eurusworkflows.blob.core.windows.net/eurusworkflows/videos/home4.mp4"]

  const podcasters = [
    { name: "Alex Thompson", show: "The Daily Insight", video: "https://eurusworkflows.blob.core.windows.net/eurusworkflows/videos/1.mp4" },
    { name: "Sophia Chen", show: "Literary Legends", video: "https://eurusworkflows.blob.core.windows.net/eurusworkflows/videos/2.mp4" },
    { name: "Emma Rodriguez", show: "Urban Perspectives", video: "https://eurusworkflows.blob.core.windows.net/eurusworkflows/videos/3.mp4" },
    { name: "Marcus Johnson", show: "Tech Unpacked", video: "https://eurusworkflows.blob.core.windows.net/eurusworkflows/videos/4.mp4" },
    { name: "Sarah Williams", show: "Creative Minds", video: "https://eurusworkflows.blob.core.windows.net/eurusworkflows/videos/5.mp4" },
    { name: "David Park", show: "Future Forward", video: "https://eurusworkflows.blob.core.windows.net/eurusworkflows/videos/6.mp4" },
    { name: "Lisa Anderson", show: "Health & Wellness", video: "https://eurusworkflows.blob.core.windows.net/eurusworkflows/videos/7.mp4" },
    { name: "Ryan Mitchell", show: "Business Insights", video: "https://eurusworkflows.blob.core.windows.net/eurusworkflows/videos/8.mp4" },
  ]
